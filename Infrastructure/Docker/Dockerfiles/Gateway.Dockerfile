...
# Service
COPY RetailInventory.Microservices/Gateway.OcelotGateway/Gateway.OcelotGateway.csproj Gateway.OcelotGateway/

RUN dotnet restore Gateway.OcelotGateway/Gateway.OcelotGateway.csproj
...
ENTRYPOINT ["dotnet","Gateway.OcelotGateway.dll"]